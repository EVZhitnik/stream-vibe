...
class Select extends BaseComponent {
  ...
  fixDropdownPosition = () => {
    ...
    const isButtonOfTheLeftViewportSide = buttonCenterX < viewportCenterX;

    this.dropdownElement.classList.toggle(this.stateClasses.isOnTheLeftSide, isButtonOfTheLeftViewportSide);
    this.dropdownElement.classList.toggle(this.stateClasses.isOnTheRightSide, !isButtonOfTheLeftViewportSide);
  }
